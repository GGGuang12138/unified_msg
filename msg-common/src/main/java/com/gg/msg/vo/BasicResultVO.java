...
public final class BasicResultVO<T> {
  ...
  public BasicResultVO(ResultStatus status) {
    this(status, null);
  }

  public BasicResultVO(ResultStatus status, T data) {
    this(status, status.getMsg(), data);
  }

  public BasicResultVO(ResultStatus status, String msg, T data) {
  ...
  public static BasicResultVO<Void> success() {
    return new BasicResultVO<>(ResultStatus.SUCCESS);
  }
  ...
  public static <T> BasicResultVO<T> success(String msg) {
    return new BasicResultVO<>(ResultStatus.SUCCESS, msg, null);
  }
  ...
  public static <T> BasicResultVO<T> success(T data) {
    return new BasicResultVO<>(ResultStatus.SUCCESS, data);
  }
   ...
   * @return 自定义状态的失败响应
   */
  public static <T> BasicResultVO<T> fail(ResultStatus status) {
   ...
   */
  public static <T> BasicResultVO<T> fail(ResultStatus status, String msg) {
